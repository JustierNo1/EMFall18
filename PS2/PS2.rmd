...
```{r, message=FALSE, warning=FALSE, results='asis'}
Model6 = lw ~ educ + age + female + female:educ + female:age
...
We identify the single elements: $R^2_U$ is `r summary(lm6)$r.squared` from the summary statistics of lm6. Same for $R^2_R$, found in the summary statistics of lm4: `r summary(lm4)$r.squared`.
\begin{align*}
...
To do the same in R:
```{r}
 linearHypothesis(lm6, c("female + educ:female + age:female"))
```
